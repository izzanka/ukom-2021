...
if(isset($_REQUEST['submit'])){
    extract($_REQUEST);
    $menu->update($id,$nama_menu,$harga);
    if($menu){
        header("location:index.php");
    }else{
        echo "update data menu error";
    }
}
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="" onSubmit="return validasi()">
                            <input type="hidden" name="id" value="<?php echo $data_menu['id']; ?>">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Nama Menu </label>
                                    <input type="text" class="form-control" name="nama_menu" id="nama_menu" value="<?php echo $data_menu['nama_menu']; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Harga </label>
                                    <input type="text" class="form-control" name="harga" id="harga" value="<?php echo $data_menu['harga']; ?>">
                                </div>
                            </div>
